...
Insert Into AddressBook Values('Donald', 'JK', 'Thoothukudi', 'Thoothukudi', 'TamilNadu', 245455, 8698669929, 'donald@gmail.com'),
						('Leo', 'Carmel', 'Tirunelveli', 'Thoothukudi', 'TamilNadu', 242221, 3215648973, 'carmelleo@gmail.com'),	
						('Joushua', 'Raphael', 'Madurai', 'Thoothukudi', 'TamilNadu', 264032, 7315664458, 'raphael@gmail.com'),	
						('Nishanth', 'Jef', 'Mumbai', 'Thoothukudi', 'TamilNadu', 55055, 9923223366, 'nishanth@gmail.com'),	
						('Shahan', 'C', 'Banglore', 'Thoothukudi', 'TamilNadu', 121412, 8180714191, 'shahan@gmail.com');
Select * From AddressBook;

------ UC-4 Edit Existing Contact to AddressBook Table -------
Update AddressBook Set EmailId='donald@gmail.com' Where FirstName='Donald';
Update AddressBook Set Address='Nagar', City = 'chennai', StateName = 'Maharashtra' Where FirstName='Shahan';
Update AddressBook Set Phonenum=9087741630 Where FirstName='Nishanth';
Select * From AddressBook;

----- UC-5 Delete Existing Contact From Table --------
Delete From AddressBook Where FirstName='Shahan' And LastName = 'C';
Select * From AddressBook;

----- UC-6 Retrieve Person Record From Table By City Or State ---------
Select * From AddressBook Where City='Madurai' Or StateName='TamilNadu';
